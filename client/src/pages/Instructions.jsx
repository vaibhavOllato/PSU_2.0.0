      ...
      <div className="p-1 flex items-center justify-center  bg-gray-100">
        <div className="bg-white border border-gray-200 shadow-lg rounded-xl p-8 max-w-3xl w-full text-center animate-fade-in">
          <h1 className="text-3xl font-bold text-gray-800 flex items-center justify-center mb-4">
            <Info className="w-8 h-8 text-yellow-600 mr-2" /> Instructions
          </h1>
          ...
          {/* Instruction Box */}
          <div className="bg-blue-50 border border-blue-300 text-yellow-700 p-6 rounded-lg shadow-md mb-6 text-left w-full">
          ...
          <div className="flex space-x-4 justify-center">
            ...
            <button
              ...
              className="px-6 py-2 bg-yellow-600 text-white font-semibold rounded-lg shadow-md hover:bg-yellow-700"
            >
              Start
            </button>
          </div>
