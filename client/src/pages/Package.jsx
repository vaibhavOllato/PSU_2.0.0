  ...
  return (
    <div className="p-1">
            ...
            >
              ...
              <div
                className={`w-14 h-14 flex items-center justify-center rounded-full shadow-md text-2xl 
                  ${index === 1 ? "bg-secondary text-white" : "bg-white"}
                `}
              >
              ...
              <h2
                className={`text-lg font-semibold ${
                  index === 1 ? "text-secondary" : "text-[#dd6e42]"
                }`}
              >
                {pkg.title}
              </h2>
              ...
              <div className="flex flex-col items-center">
                ...
                <p
                  className={`text-2xl font-bold ${
                    index === 1 ? "text-secondary" : "text-secondary"
                  }`}
                >
                  ₹{pkg.finalPrice}
                </p>
      ...
      <div className="bg-white border border-gray-300 shadow-md rounded-lg p-6 container mx-auto my-10">
        <h1 className="text-xl text-secondary font-bold mb-6">Ad ons.</h1>
        <hr className="my-4 border-gray-300" />
          ...
          {sessions.map((session, index) => (
            ...
            >
              ...
              <a
                ...
                className="mt-4 w-full bg-secondary hover:bg-secondary-hover text-white font-bold py-2 px-4 rounded-lg transition-all text-center"
              >
                {session.buttonText}
              </a>
            </div>
